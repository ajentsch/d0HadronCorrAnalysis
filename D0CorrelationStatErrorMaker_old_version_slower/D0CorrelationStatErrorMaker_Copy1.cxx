...
int D0CorrelationStatErrorMaker_Copy1(){
    ...
    TFile * inputFile = new TFile("best_output_for_stat_errors_Copy1.root");
    TFile * outputFile = new TFile("output_errors_correct_6_Copy1.root", "RECREATE");
