...
//------------------------------------------
 ...
 //------------------------------------------------------------------------------------------------------------------------------------
   ...
   //-----------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    for(int k = FIRST_PT_BIN; k < NUM_PT_BINS; k++){
       ...
       double phiProjectionScaleFactor = 1.0/NUM_ETA_BINS;
        ...
        for(int k = FIRST_PT_BIN; k < NUM_PT_BINS; k++){    
            for(int i = 0; i < 3; i++){
                ...
                str1 = path + outputFolders[5] + outputFolders[8] + PtSubFolders[k] + fullySubtractedLabelCustomCentrality + bandSubtract[0] + PtBinLabel[k] + binLabelPt[k] + centralityBin[i] + fileType; //Ls
                fullySubtractedCorrCustomCentralityLS[k][i]->GetXaxis()->SetRangeUser(-ETA_RANGE, ETA_RANGE);//LS
                fullySubtractedCorrCustomCentralityLS[k][i]->Draw("SURF1");//LS
                c->SaveAs(str1);//LS
                ...
                str1 = path + outputFolders[5] + outputFolders[8] + PtSubFolders[k] + phiProj + fullySubtractedLabelCustomCentrality + bandSubtract[0] + PtBinLabel[k] + binLabelPt[k] + centralityBin[i] + fileType; //LS
 ...
 /*  ofstream dataPointsForLanny;
   ...
   /*  TCanvas *c = new TCanvas("c3", "Histograms", 1100, 850);
    ...
    myfit[4][0]->SetParLimits(0, -.1, .01);    //offset A0
    myfit[4][0]->SetParLimits(1, -.05,  0.0);    //v1     AD
    myfit[4][0]->SetParLimits(2, 0.0,  .1);    //v2     AQ
    myfit[4][0]->SetParLimits(3, 0.0, .2);    //A1 jet amp
    myfit[4][0]->SetParLimits(4, 0.1, 2);     //phi width
    myfit[4][0]->SetParLimits(5, 0.1, 2);    //eta width
	
	myfit[4][1]->SetParLimits(0, -.1, .01);    //offset A0
    myfit[4][1]->SetParLimits(1, -.05,  0.0);    //v1     AD
    myfit[4][1]->SetParLimits(2, 0.0,  .1);    //v2     AQ
    myfit[4][1]->SetParLimits(3, 0.0, .2);    //A1 jet amp
    myfit[4][1]->SetParLimits(4, 0.1, 2);     //phi width
    myfit[4][1]->SetParLimits(5, 0.1, 2);    //eta width
	
	myfit[4][2]->SetParLimits(0, -.1, .01);    //offset A0
    myfit[4][2]->SetParLimits(1, -.05,  0.0);    //v1     AD
    myfit[4][2]->SetParLimits(2, 0.0,  .1);    //v2     AQ
    myfit[4][2]->SetParLimits(3, 0.0, .2);    //A1 jet amp
    myfit[4][2]->SetParLimits(4, 0.1, 2);     //phi width
    myfit[4][2]->SetParLimits(5, 0.1, 2);    //eta width
    ...
    for(int k = 0; k < NUM_PT_BINS; k++){
        for(int i = 0; i < 3; i++){ 
            ...
            fitParameterFile1D << endl << "pt bin (4 is integrated): " << k << "    Centrality Bin (0 - per, 1 - mid cent, 2 - cent): " << i << endl;
    ...
    talkCanvas->Divide(3,3);
    
    int padNumber = 1;
    TString talkOutput = "Corrected_Correlations";
    TString ptRanges[3] = {" 1 < p_{T} < 2 GeV/c ", " 2 < p_{T} < 5 GeV/c ", " 5 < p_{T} < 10 GeV/c "};
   ...
   /////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     /* TH1D* leftSideBandTemp = new TH1D("","", 50, 1.6, 2.1);
    TH1D* rightSideBandTemp = new TH1D("","",50, 1.6, 2.1);
    TH1D* signalRegionTemp = new TH1D("","",50, 1.6, 2.1);
    leftSideBandTemp->SetStats(0);
    rightSideBandTemp->SetStats(0);
    signalRegionTemp->SetStats(0);
    
    TF1 * expoForDOEFit = new TF1("expo", "pol4", 1.7, 1.8);
    TF1 * expoForDOEFitFinal = new TF1("expo", "expo", 1.6, 2.1);
    
    TF1 *fex = new TF1("fex",fexpo,1.6,2.1,2);
    fex->SetParameters(2,-1);
    //fit only the linear background excluding the signal area
    reject = kTRUE;
    oneDUSHistos[1][1]->Fit(fex,"qR");
    reject = kFALSE;
    
    //oneDUSHistos[2][1]->Fit(expoForDOEFit);
    expoForDOEFitFinal->SetParameter(0, fex->GetParameter(0)); 
    expoForDOEFitFinal->SetParameter(1, fex->GetParameter(1));
    //expoForDOEFitFinal->SetParameter(2, expoForDOEFit->GetParameter(2));
    //expoForDOEFitFinal->SetParameter(3, expoForDOEFit->GetParameter(3)); 
    //expoForDOEFitFinal->SetParameter(4, expoForDOEFit->GetParameter(4));
    //expoForDOEFitFinal->SetParameter(5, expoForDOEFit->GetParameter(5));
    
    leftSideBandTemp->SetBinContent(11,oneDUSHistos[1][1]->GetBinContent(11));
    leftSideBandTemp->SetBinContent(12,oneDUSHistos[1][1]->GetBinContent(12));
    leftSideBandTemp->SetBinContent(13,oneDUSHistos[1][1]->GetBinContent(13));
    leftSideBandTemp->SetBinContent(14,oneDUSHistos[1][1]->GetBinContent(14));
    leftSideBandTemp->SetBinContent(15,oneDUSHistos[1][1]->GetBinContent(15));
    leftSideBandTemp->SetBinContent(16,oneDUSHistos[1][1]->GetBinContent(16));
    leftSideBandTemp->SetBinContent(17,oneDUSHistos[1][1]->GetBinContent(17));
    leftSideBandTemp->SetBinContent(18,oneDUSHistos[1][1]->GetBinContent(18));
    leftSideBandTemp->SetBinContent(19,oneDUSHistos[1][1]->GetBinContent(19));
    leftSideBandTemp->SetBinContent(20,oneDUSHistos[1][1]->GetBinContent(20));
    
    //rightSideBandTemp->SetBinContent(32,oneDUSHistos[2][2]->GetBinContent(32));
    rightSideBandTemp->SetBinContent(33,oneDUSHistos[1][1]->GetBinContent(33));
    rightSideBandTemp->SetBinContent(34,oneDUSHistos[1][1]->GetBinContent(34));
    rightSideBandTemp->SetBinContent(35,oneDUSHistos[1][1]->GetBinContent(35));
    rightSideBandTemp->SetBinContent(36,oneDUSHistos[1][1]->GetBinContent(36));
    rightSideBandTemp->SetBinContent(37,oneDUSHistos[1][1]->GetBinContent(37));
    rightSideBandTemp->SetBinContent(38,oneDUSHistos[1][1]->GetBinContent(38));
    rightSideBandTemp->SetBinContent(39,oneDUSHistos[1][1]->GetBinContent(39));
    rightSideBandTemp->SetBinContent(40,oneDUSHistos[1][1]->GetBinContent(40));
    rightSideBandTemp->SetBinContent(41,oneDUSHistos[1][1]->GetBinContent(41));
    rightSideBandTemp->SetBinContent(42,oneDUSHistos[1][1]->GetBinContent(42));
    rightSideBandTemp->SetBinContent(43,oneDUSHistos[1][1]->GetBinContent(43));
    rightSideBandTemp->SetBinContent(44,oneDUSHistos[1][1]->GetBinContent(44));
    rightSideBandTemp->SetBinContent(45,oneDUSHistos[1][1]->GetBinContent(45));
    rightSideBandTemp->SetBinContent(46,oneDUSHistos[1][1]->GetBinContent(46));
    rightSideBandTemp->SetBinContent(47,oneDUSHistos[1][1]->GetBinContent(47));
    rightSideBandTemp->SetBinContent(48,oneDUSHistos[1][1]->GetBinContent(48));
    rightSideBandTemp->SetBinContent(49,oneDUSHistos[1][1]->GetBinContent(49));
    
    //signalRegionTemp->SetBinContent(22,oneDUSHistos[1][1]->GetBinContent(22));
    signalRegionTemp->SetBinContent(23,oneDUSHistos[1][1]->GetBinContent(23));
    signalRegionTemp->SetBinContent(24,oneDUSHistos[1][1]->GetBinContent(24));
    signalRegionTemp->SetBinContent(25,oneDUSHistos[1][1]->GetBinContent(25));
    signalRegionTemp->SetBinContent(26,oneDUSHistos[1][1]->GetBinContent(26));
    signalRegionTemp->SetBinContent(27,oneDUSHistos[1][1]->GetBinContent(27));
    signalRegionTemp->SetBinContent(28,oneDUSHistos[1][1]->GetBinContent(28));
    signalRegionTemp->SetBinContent(29,oneDUSHistos[1][1]->GetBinContent(29));
    signalRegionTemp->SetBinContent(30,oneDUSHistos[1][1]->GetBinContent(30));
    //signalRegionTemp->SetBinContent(31,oneDUSHistos[1][1]->GetBinContent(31));
    
    leftSideBandTemp->SetFillColorAlpha(4, 0.35);
    rightSideBandTemp->SetFillColorAlpha(4, 0.35);
    signalRegionTemp->SetFillColorAlpha(3, 0.35);
    
    oneDUSHistos[1][1]->SetStats(0);
    oneDUSHistos[1][1]->GetYaxis()->SetTitleSize(.03);
    oneDUSHistos[1][1]->GetYaxis()->SetLabelSize(.03);
    oneDUSHistos[1][1]->GetYaxis()->SetTitleOffset(1.5);
    oneDUSHistos[1][1]->GetXaxis()->SetTitleSize(.03);
    oneDUSHistos[1][1]->GetXaxis()->SetLabelSize(.03);
    oneDUSHistos[1][1]->SetTitle("Invariant Mass of Unlike-Sign K#pi");
    oneDUSHistos[1][1]->Draw();
    expoForDOEFitFinal->Draw("SAME");
    leftSideBandTemp->Draw("SAME");
    rightSideBandTemp->Draw("SAME");
    signalRegionTemp->Draw("SAME");
    
    
    c->SaveAs("C:/Users/ajentsch/desktop/DOEInvMass.eps"); */
    
    
    
   
     /* TCanvas * finalCorrGridCanvas = new TCanvas("", "", 5500, 3000);
    finalCorrGridCanvas->Divide(5,3);
    ...
    for(int i = 0; i < 3; i++){
        for(int k = 0; k < 5; k++){
            ...
            if(i == 0) { oneDSubtractedInvMassHistos[k][i]->SetTitle(ptBinTitle[k]); }
            else oneDSubtractedInvMassHistos[k][i]->SetTitle("");
            
            tmp = "#frac{S}{#sqrt{S+B}} = ";
			str1 = Form("%.2f",sigPerBin[k][i]);
			str2 = tmp + str1;
			
			TPaveText *textBoxSignifigance2 = new TPaveText(0.15, 0.75, .40, .90, "NB NDC");
            textBoxSignifigance2->AddText(str2);
            textBoxSignifigance2->GetLine(0)->SetTextSize(.041);
            
			oneDSubtractedInvMassHistosFunction[k][i]->Draw();
			textBoxSignifigance2->Draw("SAME");
            
            ////oneDSubtractedInvMassHistosFunction[k][i]->Draw("SAME");
    ...
    finalCorrGridCanvas->SaveAs("C:/users/ajentsch/desktop/InvMassGrid.png"); */
